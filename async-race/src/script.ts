import { wrap, containerCar, containerImages } from './components/wrapper/wrapper';
...
import { carFooter, carHeader } from './components/car-header/car_parts';
import { carImage, flagImage } from './components/svg/svg';
import { nameCar } from './components/name/name';
